...
import es.jllopezalvarez.accesodatos.ejemplos.ejemplosspringdata.ejemplocrudrepository.repositories.CountryRepository;
...
public class EjemplosJpa implements CommandLineRunner {
    ...
    public EjemplosJpa(CountryRepository countryRepository, ActorService actorService, CategoryService categoryService, FilmService filmService, InventoryService inventoryService) {
    ...
    public static void main(String[] args) {
        SpringApplication.run(EjemplosJpa.class, args);
    }

    @Override
    public void run(String... args) throws Exception {
//        ejemplo00ConsultaPais();
...
//        ejemplo06DerivedQueries();
    ...
    private void ejemplo00ConsultaPais() {
        var paises = countryRepository.findAll();
    ...
    private void ejemplo02InsercionRepo() {
        ...
        // Restaurar el valor de identity. Esto se tiene que hacer un un usuario con suficientes permisos (root, p.ej.)
