...
public class Ejemplo01Leer {
    public static void main(String[] args) {
        ...
        try (EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory(Constants.SAKILA_PERSISTENCE_UNIT); EntityManager entityManager = entityManagerFactory.createEntityManager()) {
    ...
    private static void usandoFind(EntityManager entityManager) {
        ...
        System.out.println("Buscamos categoría con ID 10, usando find.");
        Category categoryFind = entityManager.find(Category.class, 10);
    ...
    private static void usandoGetReference(EntityManager entityManager) {
        System.out.println("Buscamos categoría con ID 5, usando getReference.");
        ...
        Category categoryGetRef = entityManager.getReference(Category.class, "5");
    ...
    private static void usandoJpql(EntityManager entityManager) {
        ...
        System.out.println("Buscamos la categoría con ID = 10, usando JPQL.");
        int categoryId = 10;
        ...
        singleItemQuery.setParameter("catId", categoryId);
    ...
    private static void usandoSqlNativo(EntityManager entityManager) {
        System.out.println("Buscamos la categoría con ID = 7, usando SQL Nativo.");
        int categoryId = 7;
